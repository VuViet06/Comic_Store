            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="condition" required
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                        <option value="in_stock" {{ old('condition', $comic->condition) == 'in_stock' ? 'selected' : '' }}>Còn hàng</option>
                        <option value="coming_soon" {{ old('condition', $comic->condition) == 'coming_soon' ? 'selected' : '' }}>Sắp có hàng</option>
                        <option value="out_of_stock" {{ old('condition', $comic->condition) == 'out_of_stock' ? 'selected' : '' }}>Hết hàng</option>
                    </select>
                </div>
