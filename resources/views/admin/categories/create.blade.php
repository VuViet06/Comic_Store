...
@section('content')
<div class="max-w-2xl">
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6 space-y-6">
        @csrf
        ...
        <div class="flex items-center justify-end gap-4">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Tạo danh mục</button>
        </div>
    </form>
</div>
@endsection
